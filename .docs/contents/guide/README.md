...
3、目前已经有超过20多家公司在生产环境中使用，当然实际中更多，具体查看 [点击查看使用的情况](https://github.com/anjoy8/Wyj.Core/issues/75)。  
...
- [√] 封装`Wyj.Core.Webapi.Template`项目模板，一键重建自己的项目 ✨；
