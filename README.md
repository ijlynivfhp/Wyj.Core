...
Wyj.Core 开箱即用的企业级前后端分离【 .NET Core6.0 Api + Vue 2.x + RBAC】权限框架。  
其他版本看具体分支吧🎉  
官网：http://apk.neters.club/.doc/    

  
  
**已被多家公司所使用(80+🐱‍🚀)：[点击查看列表](https://github.com/anjoy8/Wyj.Core/issues/75)**   欢迎盖楼，留下公司真实名字的，可得定制化指导服务。
...
```
1、A~CoderDong:
应用场景：使用Wyj.Core为基础骨架开发，搭建Client监控类守护进程项目，To C 客户群，
...
- [x] 封装`Wyj.Core.Webapi.Template`项目模板，一键重建自己的项目 ✨；
...
如果你的项目中借鉴了本项目，请稍微说明下[https://github.com/anjoy8/Wyj.Core/issues/75](https://github.com/anjoy8/Wyj.Core/issues/75)，开源不易✨。  

## 贡献者们 

Thanks goes to these wonderful people ([✨](https://github.com/anjoy8/Wyj.Core/graphs/contributors)):（排名暂时按提交顺序）
...
This project follows the [all-contributors](https://github.com/anjoy8/Wyj.Core/graphs/contributors) specification.
...
| ------- | -------- | ------- |
| [Wyj.Core.Webapi.Template](https://www.nuget.org/packages/Wyj.Core.Webapi.Template/) | [![Wyj.Core.Webapi.Template](https://img.shields.io/nuget/v/Wyj.Core.Webapi.Template.svg)](https://www.nuget.org/packages/Wyj.Core.Webapi.Template/)  | [![Wyj.Core.Webapi.Template](https://img.shields.io/nuget/dt/Wyj.Core.Webapi.Template.svg)](https://www.nuget.org/packages/Wyj.Core.Webapi.Template/) |
...
|[NetCore-Sugar-Demo](https://github.com/anjoy8/NetCore-Sugar-Demo)|[Blog.SplRepository.Demo](https://github.com/anjoy8/Blog.SplRepository.Demo)|[Wyj.Core](https://github.com/anjoy8/Wyj.Core)|[ChristDDD](https://github.com/anjoy8/ChristDDD)|
